          ...
          <>
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-white p-4">
              <div className="overflow-hidden aspect-[4/3] md:aspect-video">
                <img
                  src="https://images.unsplash.com/photo-1753162658653-d33c53910d9e?q=80&w=1331&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  alt="Atelier detail"
